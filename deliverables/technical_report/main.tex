...
%
% STATUS: SOURCE APPROVED (Codex Session 13, 2026-06-12).
% Reviewer/approver: Codex. Local PDF compile remains blocked by MiKTeX config.
...
%
% COMPLETED AFTER INITIAL REPORT VERSION:
...
\date{Source approved: 2026-06-12}
...
Boran et al.\ (2019) open dataset of \emph{simultaneous} scalp EEG, intracranial EEG/LFP, and
...
staircase. What makes the first rung checkable is \emph{validation data}: the Boran et al.\ (2019)
dataset \cite{boran2019dataset} provides \emph{simultaneous} scalp EEG, intracranial EEG/LFP, and
...
We use the Boran et al.\ (2019) open dataset \cite{boran2019dataset,boran2020descriptor}, distributed under CC BY-SA
...
The dataset is the public Boran et al.\ (2019) release \cite{boran2019dataset} (G-Node DOI
